...
class XPS(object):
    ...
    def EventAdd(self, socketId, PositionerName, EventName, EventParameter, ActionName, ActionParameter1, ActionParameter2,
                ActionParameter3):
        if (XPS.__usedSockets[socketId] == 0):
            return
    ...
    def EventExtendedConfigurationTriggerSet(self, socketId, ExtendedEventName, EventParameter1, EventParameter2,
        ...
        for i in range(len(ExtendedEventName)):
            if (i > 0):
                command += ','
            command += ExtendedEventName[i] + ',' + EventParameter1[i] + ',' + EventParameter2[i] + ',' + EventParameter3[
                i] + ',' + EventParameter4[i]
        command += ')'
    ...
    def GroupPositionCurrentGet(self, socketId, GroupName, nbElement):
        ...
        for paramNb in range(nbElement):
            ...
            while ((i + j) < len(returnedString) and returnedString[i + j] != ','):
                j += 1
            retList.append(str(returnedString[i:i + j]))
            i, j = i + j + 1, 0
    ...
    def PositionerAnalogTrackingVelocityParametersSet(self, socketId, PositionerName, GPIOName, Offset, Scale,
        ...
        command = 'PositionerAnalogTrackingVelocityParametersSet(' + PositionerName + ',' + GPIOName + ',' + str(
            Offset) + ',' + str(Scale) + ',' + str(DeadBandThreshold) + ',' + str(Order) + ',' + str(Velocity) + ',' + str(
            Acceleration) + ')'
        [error, returnedString] = self.__sendAndReceive(socketId, command)
        return [error, returnedString]
    ...
    def PositionerCompensationFrequencyNotchsSet(self, socketId, PositionerName, NotchFrequency1, NotchBandwidth1,
                                                NotchGain1, NotchFrequency2, NotchBandwidth2, NotchGain2, NotchFrequency3,
                                                NotchBandwidth3, NotchGain3):
        if (XPS.__usedSockets[socketId] == 0):
            return
    
        command = 'PositionerCompensationFrequencyNotchsSet(' + PositionerName + ',' + str(NotchFrequency1) + ',' + str(
            NotchBandwidth1) + ',' + str(NotchGain1) + ',' + str(NotchFrequency2) + ',' + str(NotchBandwidth2) + ',' + str(
            NotchGain2) + ',' + str(NotchFrequency3) + ',' + str(NotchBandwidth3) + ',' + str(NotchGain3) + ')'
        [error, returnedString] = self.__sendAndReceive(socketId, command)
        return [error, returnedString]
    ...
    def PositionerCompensationNotchModeFiltersSet(self, socketId, PositionerName, NotchModeFr1, NotchModeFa1, NotchModeZr1,
    ...
    def PositionerCorrectorP2IDFFAccelerationSet(self, socketId, PositionerName, ClosedLoopStatus, KP, KI, KI2, KD, KS,
        ...
        command = 'PositionerCorrectorP2IDFFAccelerationSet(' + PositionerName + ',' + str(ClosedLoopStatus) + ',' + str(
            KP) + ',' + str(KI) + ',' + str(KI2) + ',' + str(KD) + ',' + str(KS) + ',' + str(IntegrationTime) + ',' + str(
            DerivativeFilterCutOffFrequency) + ',' + str(GKP) + ',' + str(GKI) + ',' + str(GKD) + ',' + str(
            KForm) + ',' + str(KFeedForwardAcceleration) + ',' + str(KFeedForwardJerk) + ',' + str(
    ...
    def PositionerDriverFiltersSet(self, socketId, PositionerName, KI, NotchFrequency, NotchBandwidth, NotchGain,
        ...
        command = 'PositionerDriverFiltersSet(' + PositionerName + ',' + str(KI) + ',' + str(NotchFrequency) + ',' + str(
            NotchBandwidth) + ',' + str(NotchGain) + ',' + str(LowpassFrequency) + ')'
        [error, returnedString] = self.__sendAndReceive(socketId, command)
        return [error, returnedString]
    ...
    def PositionerExcitationSignalSet(self, socketId, PositionerName, Mode, Frequency, Amplitude, Time):
        ...
        command = 'PositionerExcitationSignalSet(' + PositionerName + ',' + str(Mode) + ',' + str(Frequency) + ',' + str(
            Amplitude) + ',' + str(Time) + ')'
        [error, returnedString] = self.__sendAndReceive(socketId, command)
        return [error, returnedString]
    ...
    def PositionerMaximumVelocityAndAccelerationGet(self, socketId, PositionerName):
        ...
        PositionerName=PositionerName.decode()
    ...
    def PositionerMotionDoneGet(self, socketId, PositionerName):
        if (XPS.__usedSockets[socketId] == 0):
            return
        Posname=PositionerName.decode()
        command = 'PositionerMotionDoneGet(' + Posname + ',double *,double *,double *,double *,double *)'
        [error, returnedString] = self.__sendAndReceive(socketId, command)
        if (error != 0):
            return [error, returnedString]
    ...
    def PositionerMotionDoneSet(self, socketId, PositionerName, PositionWindow, VelocityWindow, CheckingTime, MeanPeriod,
                                TimeOut):
        if (XPS.__usedSockets[socketId] == 0):
            return
    ...
    def PositionerPositionCompareAquadBWindowedSet(self, socketId, PositionerName, MinimumPosition, MaximumPosition):
        ...
        command = 'PositionerPositionCompareAquadBWindowedSet(' + PositionerName + ',' + str(MinimumPosition) + ',' + str(
            MaximumPosition) + ')'
        [error, returnedString] = self.__sendAndReceive(socketId, command)
        return [error, returnedString]
    ...
    def PositionerPositionComparePulseParametersSet(self, socketId, PositionerName, PCOPulseWidth, EncoderSettlingTime):
        ...
        command = 'PositionerPositionComparePulseParametersSet(' + PositionerName + ',' + str(PCOPulseWidth) + ',' + str(
            EncoderSettlingTime) + ')'
        [error, returnedString] = self.__sendAndReceive(socketId, command)
        return [error, returnedString]
    ...
    def XYZGroupPositionPCORawEncoderGet(self, socketId, GroupName, PositionX, PositionY, PositionZ):
        ...
        command = 'XYZGroupPositionPCORawEncoderGet(' + GroupName + ',' + str(PositionX) + ',' + str(PositionY) + ',' + str(
            PositionZ) + ',double *,double *,double *)'
        [error, returnedString] = self.__sendAndReceive(socketId, command)
        if (error != 0):
            return [error, returnedString]
